export default function Characters() {
    return (
        <section
            id="characters"
            className="bg-[#090909] py-24 md:py-40"
        >
            <div className="mx-auto max-w-7xl px-6 md:px-8">

                <p className="mb-4 md:mb-6 uppercase tracking-[0.35em] text-xs md:text-base text-[#c8a46b]">
                    Die Hauptfiguren
                </p>

                <h2 className="mb-14 md:mb-24 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-semibold leading-tight">
                    Zwei Frauen.
                    <br />
                    Zwei Welten.
                </h2>
                ...
                <div className="grid gap-12 md:gap-20 lg:grid-cols-2">
                    ...
                    <div className="border-l border-[#c8a46b]/30 pl-5 md:pl-8">

                        <h3 className="mb-6 md:mb-8 text-3xl md:text-4xl">
                            Alva
                        </h3>

                        <p className="text-base md:text-lg leading-8 md:leading-9 text-stone-300">
