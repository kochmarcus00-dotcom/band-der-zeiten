export default function Journey() {
    return (
        ...
        <section
            className="relative overflow-hidden bg-[#090909] py-56"
        >
            ...
            <div className="relative z-10 mx-auto max-w-5xl px-8 text-center">
                ...
                <h2 className="mt-10 text-5xl md:text-7xl font-semibold leading-tight">
                ...
                <p className="mx-auto mt-20 max-w-3xl text-xl leading-10 text-stone-300">
                ...
                <div className="mt-20">
                    ...
                    <a
                        ...
                        className="inline-flex rounded-full bg-[#c8a46b] px-10 py-5 text-lg font-semibold text-[#111] transition duration-300 hover:scale-105 hover:bg-[#d8b16d]"
                    >
                        Die Reise beginnen
                    </a>
                ...
                <div className="mx-auto mt-28 h-px w-24 bg-[#c8a46b]/40" />

                <p className="mt-10 text-sm uppercase tracking-[0.35em] text-stone-500">
